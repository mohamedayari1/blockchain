...
const file_types_proto_rawDesc = "" +
	"\n" +
	"\vtypes.proto\x12\x05proto\"f\n" +
	"\x05Block\x12%\n" +
	"\x06header\x18\x01 \x01(\v2\r.proto.HeaderR\x06header\x126\n" +
	"\ftransactions\x18\x02 \x03(\v2\x12.proto.TransactionR\ftransactions\"\x90\x01\n" +
	"\x06Header\x12\x18\n" +
	...
	"\vTransactionB+Z)github.com/mohamedayari1/blockchain/protob\x06proto3"
...
var file_types_proto_depIdxs = []int32{
	1, // 0: proto.Block.header:type_name -> proto.Header
	2, // 1: proto.Block.transactions:type_name -> proto.Transaction
